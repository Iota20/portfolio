...
function Projects() {
  ...
  return (
    <section id="projects" className="relative flex min-h-screen flex-col overflow-hidden border-t-[20px] border-gray-500 pt-16 shadow-[0_10px_24px_rgba(0,0,0,0.65)]">
      ...
      <div className="relative flex flex-1 items-center justify-center">
        ...
        {currentProject && (
          <article className="relative z-10 mx-auto flex min-h-[60vh] max-w-xl flex-col gap-6 px-6 py-6">
